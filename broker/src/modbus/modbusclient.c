...
modbus_t* getModbusConn(char* host,int port){
...
int  readValue(modbus_t* ctx,int addr,int nb,uint16_t* tab_rp_registers){
    int rc=modbus_read_registers(ctx, addr, nb, tab_rp_registers);
    return rc;
}
